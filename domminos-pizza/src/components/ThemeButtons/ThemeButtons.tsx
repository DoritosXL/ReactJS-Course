...
export const ThemeButtons = ({ setTheme }: ThemeButtonsProps) => {
    ...
    return (
        <>
            <GenericButton
                handleToggle={handleToggleThemeLight}
                title="Toggle theme to light"
            >
                ☀️
            </GenericButton>
            <GenericButton
                handleToggle={handleToggleThemeDark}
                title="Toggle theme to dark"
            >
                🌙
            </GenericButton>
            <GenericButton
                handleToggle={handleToggleThemeSystem}
                title="Toggle theme to system"
            >
                🌐
            </GenericButton>
        </>
